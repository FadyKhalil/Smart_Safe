...
rcc_tenuErrorState Rcc_Enable_clock(u8 copy_u8clocktype) {
	    u32 timeout = 50;
		volatile u32 RDY;
...
rcc_tenuErrorState Rcc_Control_system_clk(u8 copy_u8Clocktype) {
...
rcc_tenuErrorState Rcc_GetClock_Status(u8 copy_u8Clocktype,
...
rcc_tenuErrorState Rcc_PLLConfiguration(u8 copy_u8Mprescalar,
...
rcc_tenuErrorState Rcc_PrescalarBusControl(u32 copy_u32Bustype,
...
rcc_tenuErrorState Rcc_EnablePeripheral(u32 copy_u32Bustype,
