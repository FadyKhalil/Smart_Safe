...
/* ///////////////////////////////// Global Variables ///////////////////////////////// */
static pfCallBackFn_t Usart_pfarrCallBackFn[3][10] =
{ Std_NULL };

static Std_tstrBuffer * Usart_pstrarrDataBuffers[3] =
{ Std_NULL };

static Std_tstrBuffer * Usart_pstrarrReceiveBuffers[3] =
{ Std_NULL };
...
Usart_tenuError Usart_enuSendBufferZC(u8 Copy_u32BusId, Std_tstrBuffer * Add_pstrBuffer)
{
	Usart_tenuError Loc_enuReturnStatus = Usart_enuOk;
	if (Add_pstrBuffer == Std_NULL)
	{
		Loc_enuReturnStatus = Usart_enuNullPointer;
	}
...
Usart_tenuError Usart_enuReceiveBufferZC(u8 Copy_u32BusId, Std_tstrBuffer * Add_pstrBuffer)
{
	Usart_tenuError Loc_enuReturnStatus = Usart_enuOk;
	if (Add_pstrBuffer == Std_NULL)
	{
...
/*
 Usart_tenuError Usart_enuRegCallbackFn(pfCallBackFn_t Add_pfCallbackFn)
 Description         :     Register the Usart interrupt callback fn
 Parameter           :     Address of the callback fn
 Return              :     Error status of type "Usart_tenuError", defined in "Usart.h" under "Error type" section
 ////////////////////// Synchronous //////////////////////
 */
Usart_tenuError Usart_enuRegCallbackFn(u8 Copy_u32BusId, u8 Copy_u8Flag, pfCallBackFn_t Add_pfCallbackFn)
{
	Usart_tenuError Loc_enuReturnStatus;
