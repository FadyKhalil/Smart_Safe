...
void Nvic_vidSetPriorityGroup(u32 Copy_u32Group)
{

	if (!(Copy_u32Group & ~(0x700)))
	{


		u32 Loc_u32TempRegister;
		Loc_u32TempRegister = ACIR;
		Loc_u32TempRegister &= ~(0xFA050700);
		Loc_u32TempRegister |= (Copy_u32Group | NVIC_VETKEY);


		ACIR = Loc_u32TempRegister;
	}
